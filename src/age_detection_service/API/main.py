...
class ProbabilityItem(BaseModel):
    ...
    confidence_percent: float = Field(..., ge=0, le=100, description="Confianza en porcentaje")

class PredictionResponse(BaseModel):
    """Respuesta completa de prediccion de edad."""
    predicted_age_range: str = Field(..., description="Rango de edad predicho")
    confidence_percent: float = Field(..., ge=0, le=100, description="Confianza principal")
    all_probabilities: List[ProbabilityItem] = Field(..., description="Probabilidades por clase")
    success: bool = Field(default=True)
    filename: str = Field(..., description="Nombre del archivo")

MODEL_NAME = "prithivMLmods/facial-age-detection"
ID2LABEL = {
    0: "Edad 01-10", 1: "Edad 11-20", 2: "Edad 21-30", 3: "Edad 31-40",
    4: "Edad 41-55", 5: "Edad 56-65", 6: "Edad 66-80", 7: "Edad 80+"
}
